...
$row_fetch = $results->fetch_assoc()
    ...
    ?>
		...
		<form method="post" id="update_invoice">
			<input type="hidden" name="action" value="update_invoice_pharmacy">
...
print	"<tr><td><b style='color:blue'>" . $sts. "</b></td>
 ...
 $get_balance_ = "SELECT *,  b.invoice_type as binv_type , count(b.invoice_id) as counted_b , i.invoice as invoice_right, b.Timestamp as btimestamp
from invoices i
 Join balance_invoices b
ON b.invoice_id = i.invoice
WHERE b.old_invoice_id = '$Get_invoice_id'
