		...
		<div class="panel panel-default">
			...
			<form method="post" id="add_category" >					
				<input type="hidden" name="action" value="add_category">
					...
					<div class="row">
					<div class="col-xs-4">
							<input type="text" class="form-control required" name="categories_name" placeholder="Enter Categories Name">
						</div>
						<div class="col-xs-4">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_add_category" class="btn btn-success float-right" value="Add Category" data-loading-text="Adding...">
