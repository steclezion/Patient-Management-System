...
<h1>Edit Procedure/Examinations</h1>
<hr>
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Editing Procedures/ Examinations (<?php echo $getID; ?>)</h4>
			</div>
				...
				<form method="post" id="update_product">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_update_product" class="btn btn-success float-right" value="Update Procedure" data-loading-text="Updating...">
						</div>
					</div>
				</form>
			</div>
