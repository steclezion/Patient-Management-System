	...
	<div class="col-xs-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Inquiries sent within  100   days</h4>
                        
        <a href="request_from_dr-pharmacy.php#" class="btn btn-primary">New Prescribed Requests</a>
    <a href="pending_inquiriesfrom_dr_prescribed.php#" class="btn btn-warning">Pending Prescribed Requests </a>
    <a href="posted-list.php" class="btn btn-success active">All Prescribed Requests</a>
