...
if ($action == 'create_invoice'){
	...
	$invoice_date = addslashes($_POST['invoice_date']); // invoice date
	$custom_email = addslashes($_POST['custom_email']); // custom invoice email
	$invoice_due_date = addslashes($_POST['invoice_due_date']); // invoice due date
...
if($action == 'delete_invoice') {
	...
	if($mysqli -> multi_query($query)) {
		...
		echo json_encode(array(
			'status' => 'Success',
			'message'=> 'Procudure has been deleted successfully!'
		));
