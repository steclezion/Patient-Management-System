...
<h2>Create New <span class="invoice_type">RECEIPT</span> For Invoice <b style="color:blue"> <?php echo $Get_invoice_id;   ?>  </b>  </h2>
<!-- <hr> -->
...
<form method="post" id="create_invoice_from_pharmacy">
	<input type="hidden" name="action" value="create_invoice_from_invoice_from_pharmacy">
	...
	<span title="Requested Medicines" > <?php 
	$search = ',';
	$replace = ' ';
	$subject = $Medicine_name;
...
<br>
			<div class="row">
				...
				<div class="col-xs-3">
					<div class="input-group input-group-sm">
						...
						aria-describedby="sizing-addon1" placeholder="0.00" width="60%"  id="invoice_patient_paying" Placeholder="0.00">
					</div>
				</div>
			</div>
		...
		<div class="col-xs-6 margin-top btn-group">
			<input type="submit" id="action_create_invoice_from_pharmacy" class="btn btn-success float-right" value="Create Invoice"
