...
<form method="post" id="create_invoice_from_pharmacy_new">
	<input type="hidden" name="action" value="create_invoice_from_pharmacy_new">
	...
	<div id="invoice_totals" class="padding-right row text-right">
		...
		<div class="col-xs-6 margin-top btn-group">
			<input type="submit" id="action_create_invoice_from_pharmacy_new" class="btn btn-success float-right" value="Create Invoice"
